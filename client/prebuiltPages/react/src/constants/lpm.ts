...
export const LPM_DEMO_META: Record<LPMName, LPMDemoMeta> = {
  ...
  airtelKenya: { currency: "USD", eligibilityKey: "airtel_kenya" },
  airtelTanzania: { currency: "USD", eligibilityKey: "airtel_tanzania" },
  pesalink: { currency: "USD", eligibilityKey: "pesalink" },
  halopesa: { currency: "USD", eligibilityKey: "halopesa" },
  spei: { currency: "MXN", eligibilityKey: "spei" },
  picpay: { currency: "BRL", eligibilityKey: "picpay" },
  nigeriaBanks: { currency: "USD", eligibilityKey: "nigeria_banks" },
  opay: { currency: "USD", eligibilityKey: "opay" },
  naverpay: { currency: "USD", eligibilityKey: "naverpay" },
  codi: { currency: "MXN", eligibilityKey: "codi" },
  payattitude: { currency: "USD", eligibilityKey: "payattitude" },
  dimo: { currency: "BRL", eligibilityKey: "dimo" },
  pse: { currency: "USD", eligibilityKey: "pse" },
  qrph: { currency: "PHP", eligibilityKey: "qrph" },
  vietqr: { currency: "USD", eligibilityKey: "vietqr" },
  mixxByYas: { currency: "USD", eligibilityKey: "mixx_by_yas" },
  breB: { currency: "USD", eligibilityKey: "bre_b" },
  promptpayQr: { currency: "THB", eligibilityKey: "promptpay_qr" },
  nequi: { currency: "USD", eligibilityKey: "nequi" },
  truemoney: { currency: "THB", eligibilityKey: "truemoney" },
  nupay: { currency: "USD", eligibilityKey: "nupay" },
  shopeepay: { currency: "IDR", eligibilityKey: "shopeepay" },
};
