async function onPayPalWebSdkLoaded() {
  try {
    ...
    if (isEligible) {
      ...
      showMessage({ text: "Indomaret is not eligible. Please ensure your buyer country is Indonesia and currency is IDR.", type: "error" });
    }
  } catch (error) {
...
function setupPayment(sdkInstance) {
  try {
    const apmCheckout = sdkInstance.createIndomaretOneTimePaymentSession({ onApprove: handleApprove, onCancel: handleCancel, onError: handleError });
