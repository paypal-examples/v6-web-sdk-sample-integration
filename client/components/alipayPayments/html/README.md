...
This demo shows how to integrate Alipay payments using the PayPal v6 Web SDK. Alipay is a leading digital wallet in China, enabling customers to pay securely online.

## 🏗️ Architecture Overview

- Loads PayPal Web SDK with Alipay component
- Checks eligibility for Alipay
- Creates an Alipay payment session with required fields (full name)
...
- Enable Alipay in your PayPal sandbox merchant account settings
...
### Client Setup
1. `cd client/components/alipayPayments/html`
2. `npm install`
3. `npm start` (runs on http://localhost:3000)

## How It Works

1. Loads PayPal SDK and initializes with Alipay component
2. Checks eligibility for Alipay
3. Renders full name field
4. On button click, validates field and creates an order
5. Launches Alipay popup for payment
...
## Troubleshooting
- **Alipay not eligible:** Ensure testBuyerCountry is set to "CN" and Alipay is enabled in your PayPal account
