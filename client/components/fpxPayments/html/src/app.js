async function onPayPalWebSdkLoaded() {
  try {
    ...
    if (isEligible) {
      ...
      showMessage({ text: "FPX is not eligible. Please ensure your buyer country is Malaysia and currency is MYR.", type: "error" });
    }
  } catch (error) {
...
function setupPayment(sdkInstance) {
  try {
    const apmCheckout = sdkInstance.createFpxOneTimePaymentSession({ onApprove: handleApprove, onCancel: handleCancel, onError: handleError });
