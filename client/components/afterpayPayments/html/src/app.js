async function onPayPalWebSdkLoaded() {
  try {
    ...
    const sdkInstance = await window.paypal.createInstance({
      clientId,
      testBuyerCountry: "US", // United States for Afterpay testing
    ...
    if (isAfterpayEligible) {
      ...
      showMessage({
        text: "Afterpay is not eligible. Please ensure your buyer country is United States and currency is USD.",
        type: "error",
      });
