...
This example demonstrates how to integrate Zip payments using PayPal's v6 Web SDK. Zip is a popular "Buy Now, Pay Later" service in Australia and New Zealand.
...
1. **SDK Initialization**: Loads PayPal Web SDK with Zip components using a client ID fetched from the server's `/paypal-api/auth/browser-safe-client-id` endpoint
